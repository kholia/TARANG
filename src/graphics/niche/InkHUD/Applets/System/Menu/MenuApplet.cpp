...
void InkHUD::MenuApplet::execute(MenuItem item)
{
    ...
    case SET_REGION_IN_433:
        applyLoRaRegion(meshtastic_Config_LoRaConfig_RegionCode_IN_433);
        break;
...
void InkHUD::MenuApplet::showPage(MenuPage page)
{
    ...
    case REGION:
        ...
        items.push_back(MenuItem("IN 433", MenuAction::SET_REGION_IN_433, MenuPage::EXIT));
